...
#####################################################################################
# Pulled from https://github.com/TallonKH/WiktionaryParse and moddified by Kori-San #
#####################################################################################
...
class WiktionaryParser():
    ...
    def parse(self):
                ...
                if(match):
                    ...
                    if((not self.__targetSections) or (section in self.__targetSections)):
                        ...
                        if(self.__oneSect):
                            ...
                            currentSection = currentLang.get(
                                section, list() if currentSectionName in listSects else cl.OrderedDict())
                ...
                if(currentSectionName == 'Noun'):
                    ...
                    if(self.__trackPlurals and not foundPlurals and currentLangName == 'English'):
                        ...
                        if(match):
                            ...
                            if(solvedPlurs):
                                solvedPlurs = [removeFormatting(
                                    plur) for plur in solvedPlurs]
        ...
        out = pages[:-
                    1] if self.__wordsOnly else json.dumps(pages, separators=(',', ':'))
        ...
        if(self.__trackSelf):
            ...
            print('Turned ' + str(bytesRead) + ' bytes into ' +
                  str(len(out)) + '.')
